    ...
    <main>
        <div class="user-info-container">
            ...
            <div class="profile-picture-container">
                <?php if (!empty($profilePicturePath) && file_exists($profilePicturePath)) : ?>
                    <img src="<?php echo $profilePicturePath; ?>" alt="<?php echo $profilePicturePath; ?>" class="profile-picture">
                <?php else : ?>
