...
<head>
    ...
    <title>Staff Dashboard - CatFe</title>
...
<body>
    ...
    <nav>
        <ul>
           <li><a href="../dashboard/dashboard_staff.php">Dashboard</a></li>
           <li><a href="../pages/view_work_slots.php">View Work Slots</a></li>
           <li><a href="../pages/view_bids.php">View Bids</a></li>
    ...
    <main>
        <div class="user-info-container">
            <div class="user-details">
                ...
                <p><strong>Café Role:</strong> <?php echo isset($userInfo['cafe_role']) ? $userInfo['cafe_role'] : 'No role assigned'; ?></p>
                <p><strong>Max Work Slots:</strong> <?php echo isset($userInfo['save_work_slots']) ? $userInfo['save_work_slots'] : 'N/A'; ?></p>
                <!-- Edit button -->
